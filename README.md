...
Прошел профессиональную переподготовку в Нетологии по программе [Java-разработчик с нуля](https://netology.ru/programs/java-developer#/). Получил диплом установленного образца. Уверенно использую приобретенные навыки в проектах Java и Android.
